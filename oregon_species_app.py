...
#define the class labels that the model was trained with
...
#preprocess image so the model accepts the image dimensions
...
#Use preprocessed image and loaded model to predict class
...
#include a table to show all species classes accepted by application
